	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.isbnType}">
				<li class="fieldcontain">
					<span id="isbnType-label" class="property-label"><g:message code="book.isbnType.label" default="Isbn Type" /></span>
					
						<span class="property-value" aria-labelledby="isbnType-label"><g:fieldValue bean="${bookInstance}" field="isbnType"/></span>
